<div class="container">
  <div class="row">
        ...
        <div class="card-body">
          ...
          <form role="form" action="\logar" method="POST">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input border" type="checkbox" id="rememberMe">
    ...
    <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 text-center justify-content-center flex-column">
      <div
